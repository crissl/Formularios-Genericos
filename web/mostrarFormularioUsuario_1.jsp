...
<html>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="mostrarGRes.jsp"><img src="re.png"/> Mostrar Respuestas</a></li>
...
<body>
    ...
    <%        DB con = DB.getInstancia();
        ...
        if (listaU.isEmpty()) {
            ...
            out.print("<div class=\"col-md-2\"><p name=\"fechaf\">Fecha Formulario</p></div>");
            //out.print("<div class=\"col-md-1\"><p name=\"fechar\">Fecha Llenado</p></div>");
            ...
            if (listaF.getFirst().getTipoFormulario().equals("N") || listaF.getFirst().getTipoFormulario().equals("M")) {
                ...
                for (int i = 0; i < listaU.size(); i++) {
                    ...
                    out.print("<div class=\"col-md-2\"><input type=\"text\" style='heigth : 1px' size='10' class=\"form-control input-sm\" name=\"id\" value='" + listaU.get(i).getIdEst() + "' readonly></div>");
                    ...
                    //out.print("<div class=\"col-xs-1\"><input type=\"text\" style='heigth : 1px' size='10' class=\"form-control input-sm\" name=\"fechaf\" value='" + listaF.get(i).getFecha_crea() + "' readonly></div>");
                    out.print("<div class=\"col-md-2\"><input type=\"text\" style='heigth : 1px' size='10' class=\"form-control input-sm\" name=\"fechar\" value='" + listaR.get(i).getFecha_crea() + "' readonly></div>");
                    out.print("<div class=\"col-md-2\"><button class=\"btn btn-xs btn-primary\" type=\"text\" name=\"Submit\" value='" + Cod + "'>Ver</button>");
                    ...
                    for (int j = 0; j < listaU.size(); j++) {
                        if (aux != listaR.get(i).getIteracionRespuesta()) {
                            if (listaU.get(j).getEstLn().equals("L")) {
                                ...
                                //out.print("<div class=\"col-xs-1\"><input type=\"text\" style='heigth : 1px' size='10' class=\"form-control input-sm\" name=\"fechaf\" value='" + listaF.get(i).getFecha_crea() + "' readonly></div>");
                                out.print("<div class=\"col-xs-1\"><input type=\"text\" style='heigth : 1px' size='10' class=\"form-control input-sm\" name=\"fechar\" value='" + listaR.get(i).getFecha_crea() + "' readonly></div>");
