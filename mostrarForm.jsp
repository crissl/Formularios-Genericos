        ...
        <div class="container">
            ...
            <form name="elegir1"  method="POST" action="uploadServlet" enctype="multipart/form-data">
                <%
                        ...
                        for (int j = 0; j < listaP.size(); j++) {
                            if (listaP.get(j).getCodigo_grupo() == listaG.get(i).getCodigo_grupo()) {
                                    ...
                                    for (int cont1 = 0; cont1 < listaDC.size(); cont1++) {
                                        for (int dc = 0; dc < listaV.size(); dc++) {
                                            if (listaV.get(dc).getValores().equals(listaDC.get(cont1).getEtiqueta()) && listaV.get(dc).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                                ...
                                                rs2.close();
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-6 offset-md-3\" ><input align=\"justify\" id=\"valor\" type=\"text\" name =\"text" + numDC + "\" value=\"" + dato + "\" class=\"form-control\" readonly/></div>");
                                                out.println("</div>");
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 1) {
                                    numT++;
                                    out.println("<div class=\"col-md-3\"></div>");
                                    out.println("<div class=\"col-md-6 offset-md-3\"><input id=\"valor\" type=\"text\" name=\"valor" + numT + "\" class=\"form-control\"/></div>");
                                    //
                                    out.println("</div>");
                                }
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 2) {
                                    ...
                                    for (int k = 0; k < listaV.size(); k++) {
                                        if (listaV.get(k).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                            ...
                                            out.println("<div class=\"row\">");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-3\" align=\"justify\"><label><input type=\"checkbox\" name=\"seleccion" + numC + "\" value=\"" + listaV.get(k).getValores() + "\"> " + listaV.get(k).getValores() + "</input></label></div>");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("</div>");
                                        }
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 3) {
                                    ...
                                    for (int k = 0; k < listaV.size(); k++) {
                                        ...
                                        if (listaV.get(k).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                            ...
                                            out.println("<div class=\"row\">");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-3\" align=\"justify\" ><input type=\"radio\" name=\"radio" + numR + "\" value=\"" + listaV.get(k).getValores() + "\"> " + listaV.get(k).getValores() + "</input></div>");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("</div>");
                                        }
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 5) {
                                    ...
                                    out.println("<div class=\"row\">");
                                    out.println("<div class=\"col-md-3\"></div>");
                                    out.println("<div class=\"col-md-6\"><select type=\"text\" name=\"lista" + numL + "\">");
                                    for (int k = 0; k < listaV.size(); k++) {
                                        if (listaV.get(k).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 7) {
                                    ...
                                    out.println("<div class=\"row\">");
                                    out.println("<div class=\"col-md-3\"></div>");
                                    out.println("<div class=\"col-md-3\" align=\"justify\"><label for=\"fechaInicio\" class=\"sr-only\">fechaInicio</label><input id=\"fechaInicio" + numFech + "\" type=\"date\" name=\"fechaInicio" + numFech + "\" class=\"form-control\" placeholder=\"fechaInicio\" required/></div>");
                                    out.println("</div><br>");
                                    //out.println("</div>");
                                }
                                ///////////////////////////////////////////////////////////////////////////////
                    ...
                    out.println("</br><div class=\"col-md-4\" ><center><button class=\"btn btn-success btn-lg\" type=\"text\" name=\"Submit\" value='" + Cod + "' >Guardar</button></center></div>");
                    out.println("</div>");
                %>
            </form>
            <%
            ...
            <form name="elegir"  method="POST" action="uploadServlet" enctype="multipart/form-data">
                <%
                    ...
                    for (int i = 0; i < listaG.size(); i++) {
                        ...
                        out.println("<div class=\"row \">");
                        out.println("<div class=\"col-md-3\"></div>");
                        out.println("<div class=\"col-md-6 panel panel-info panel-heading\" align=\"justify\"><h4 class=\"panel-title\">" + listaG.get(i).getNombre_grupo() + "</h4></div>");
                        out.println("<div class=\"col-md-3\"></div>");
                        out.println("</div>");
                        out.println("<div class=\"row\">");
                        out.println("<div class=\"col-md-3\"></div>");
                        ...
                        for (int j = 0; j < listaP.size(); j++) {
                            if (listaP.get(j).getCodigo_grupo() == listaG.get(i).getCodigo_grupo()) {
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 8) {
                                    numN++;
                                    out.println("<div class=\"col-md-3\"></div>");
                                    out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><input id=\"valor\" type=\"number\" onblur=\"validarNumero()\" name=\"num" + numN + "\" class=\"form-control\"/></div>");
                                    out.println("</div>");
                                }
                                ////////////////////////////////////////////////////////////////////////////////
                    ...
                    out.println("</br></br><div class=\"col-md-4\" align=\"center\"><button class=\"btn btn-success\" type=\"text\" name=\"Submit\" value='" + Cod + "'  >Guardar</button></center></div></br>");
                    out.println("</div>");
                %>
            </form> 
            <%
            ...
            <form action="" method="POST" name="modifcar" target="_self">
                <%
                    ...
                    out.println("<div class=\"row\">");
                    out.println("<div class=\"col-md-3\"></div>");
                    out.println("<div class=\"col-md-6\" align=\"justify\"><h5 class=\"text-success text-uppercase\">" + " *" + listaF.getFirst().getDescripcion_formulario() + "</h5><center></div>");
                    out.println("</div>");
                    int numT1 = 0;
                    int numC1 = 0;
                    int numR1 = 0;
                        ...
                        for (int j = 0; j < listaP.size(); j++) {
                            if (listaP.get(j).getCodigo_grupo() == listaG.get(i).getCodigo_grupo()) {
                                    ...
                                    for (int k = 0; k < listaV.size(); k++) {
                                        ...
                                        if (listaV.get(k).getCodigo_Preguntas() == listaR.get(codR).getCodigo_preguntas()) {
                                            ...
                                            if (listaV.get(k).getValores().equals(listaR.get(codR).getValor_Respuestas())) {
                                                out.println("<div class=\"row\">");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><input type=\"checkbox\" name=\"check" + numC1 + "\" checked>" + listaV.get(k).getValores() + "</input></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("</div>");
                                                codR++;
                                                ...
                                                out.println("<div class=\"row\">");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><input type=\"checkbox\" name=\"check" + numC1 + "\">" + listaV.get(k).getValores() + "</input></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("</div>");
                                            }
                                    ...
                                    for (int k = 0; k < listaV.size(); k++) {
                                        if (listaV.get(k).getCodigo_Preguntas() == listaR.get(codR).getCodigo_preguntas()) {
                                            ...
                                            if (listaV.get(k).getValores().equals(listaR.get(codR).getValor_Respuestas())) {
                                                ...
                                                out.println("<div class=\"row\">");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><input type=\"radio\" name=\"radio" + numR1 + "\" value=\"" + listaV.get(k).getValores() + "\" checked>" + listaV.get(k).getValores() + "</input></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("</div>");
                                                ...
                                                out.println("<div class=\"row\">");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><input type=\"radio\" name=\"radio" + numR1 + "\" value=\"" + listaV.get(k).getValores() + "\" >" + listaV.get(k).getValores() + "</input></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("<div class=\"col-md-3\"></div>");
                                                out.println("</div>");
                                            }
                                ...
                                if (listaP.get(j).getCodigo_tipo_pregunta() == 5) {
                                    ...
                                    out.println("<div class=\"col-md-3\"></div>");
                                    out.println("<div class=\"col-md-6 col-md-offset-3\" align=\"justify\"><select type=\"text\" name=\"lista" + numL1 + "\">");
                                    for (int k = 0; k < listaV.size(); k++) {
                                        if (listaV.get(k).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                            if (listaV.get(k).getValores().equals(listaR.get(codR).getValor_Respuestas())) {
                                ...
                                out.println("</div></center>");//cierre if de la matriz
                    ...
                    out.println("<div class=\"row\">");
                    out.println("<br><div class=\"col-md-4\"></div>");
                    out.println("<div class=\"col-md-4\"><center><button class=\"btn btn-success btn-lg\" name=\"Submit\" onclick=\"this.form.action='modificacionFormModificable.jsp';this.form.submit();\" value=\"" + Cod + "\">Modificar</button></center></div>");
                    out.println("</div>");
                    con.closeConexion();
                    con2.closeConexion();
                %>
